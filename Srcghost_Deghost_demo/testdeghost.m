...
% figure();
% plot(t,input,t,output1,t,output2)
% legend('input','output1','output2')
...
plot(t,input,t,output2); 
legend('input','deghost2');
...
figure();
plot(f(1:hnf),finput(1:hnf),f(1:hnf),foutput2(1:hnf));
legend('finput','foutput2');
