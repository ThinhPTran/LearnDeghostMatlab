...
) 
{
  ...
  if (myfile.is_open()) {
    ...
    myfile >> tmp_string >> info.nfb;
    myfile >> tmp_string >> info.mfapp;
    myfile >> tmp_string >> info.ifscale;
    myfile >> tmp_string >> info.ifaddback;
    myfile >> tmp_string >> info.ifreshape;
  ...
  cout << "nfb: " << info.nfb << endl;
  cout << "mfapp: " << info.mfapp << endl;
  cout << "ifscale: " << info.ifscale << endl;
  cout << "ifaddback: " << info.ifaddback << endl;
  cout << "ifreshape: " << info.ifreshape << endl;
  cout << "*********************************************************************"<<endl;
  cout << endl;
