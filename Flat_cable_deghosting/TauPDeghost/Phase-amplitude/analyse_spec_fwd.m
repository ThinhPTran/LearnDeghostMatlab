function [output, freq_hz] = analyse_spec_fwd(x,wmode,Nt,dt,nfb,fmin_hz,fmax_hz,Resolution)
...
for i_iter=1:nfb
    ...
    freq_spectral(:,i_iter)=real(ifft(out_wavelet));
end

output = freq_spectral;
