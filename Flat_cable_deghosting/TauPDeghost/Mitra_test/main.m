...
fsum_input=smooth(mag2db(fsum_input));
fsum_output1=smooth(mag2db(fsum_output1));
fsum_output2=smooth(mag2db(fsum_output2));
fsum_output3=smooth(mag2db(fsum_output3));
fsum_output4=smooth(mag2db(fsum_output4));
