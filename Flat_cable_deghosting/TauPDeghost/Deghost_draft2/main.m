...
tic
extmp_inv = taup_bwd(iter_cg,exnt,ext,exnf,exf,exnx,exx,exnp,exxp,exinput_taup_deghost);
toc

tmp_exoutput = clean_non_physical_fk(1.0,vwater,exnt,ext,exnf,exf,exomega,exnx,exx,exnp,exxp,exnkx,exkx,extmp_inv);
