...
%% input data
fid=fopen('slantcable_primary_09375.bin','r');
...
tic
input_tausclp_dg=taup_slant_syn(recover_eps,alpha,vwater,nt,dt,npprime,dpprime,input_tausclp);
toc
