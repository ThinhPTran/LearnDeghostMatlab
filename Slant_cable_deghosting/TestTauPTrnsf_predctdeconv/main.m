...
%% input data
fid=fopen('slant_with_ghost_case1_agc.bin','r');
...
tic
input_taup_dg=taup_slant_dg(recover_eps,alpha,vwater,fil_lgth,nt,dt,np,dp,input_taup);
toc
...
%% Output the result
input_inv=taup_bwd(iter_cg,nt,t,nf,f,nx,x,np,p,input_taup_dg);
